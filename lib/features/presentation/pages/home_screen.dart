      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(background: HeaderHome()),
            backgroundColor:
          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                      ...
                      Row(
                        ...
                        children: [
                          DiscoverItem(
                            ...
                            discoverText: AppLocalization.of(
                              context,
                ...
                SizedBox(height: 20),
                HeadlineSection(
                  headline: AppLocalization.of(context)!.translate("homework"),
                ),
                HomeworkItem(),
                SizedBox(height: 20),
                HeadlineSection(
