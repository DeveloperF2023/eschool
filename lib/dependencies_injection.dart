...
import 'features/domain/use_cases/events/fetch_today_events_use_case.dart';
...
import 'features/presentation/manager/events/get_today_events/get_today_events_cubit.dart';
...
Future<void> setupLocator() async {
  ...
  locator.registerFactory(
    () => GetTeacherNotesCubit(fetchTeacherNoteUseCase: locator.call()),
  );
  locator.registerFactory(
    () => GetRecentEventCubit(fetchRecentEventsUseCase: locator.call()),
  );
  locator.registerFactory(
    () => GetTodayEventsCubit(fetchTodayEventsUseCase: locator.call()),
  );
  locator.registerFactory(
    () => GetDetailEventCubit(fetchEventsByIdUseCase: locator.call()),
  );
  ...
  locator.registerLazySingleton(
    () => FetchTeacherNoteUseCase(repository: locator.call()),
  );
  locator.registerLazySingleton(
    () => FetchRecentEventsUseCase(repository: locator.call()),
  );
  locator.registerLazySingleton(
    () => FetchTodayEventsUseCase(repository: locator.call()),
  );
  locator.registerLazySingleton(
    () => FetchEventsByIdUseCase(repository: locator.call()),
  );
